...
#define MAIL_ATTR_CCERT_FULL_SUBJECT "ccert_full_subject"
#define MAIL_ATTR_CCERT_FULL_ISSUER "ccert_full_issuer"
#define MAIL_ATTR_CCERT_SERIAL_NUMBER "ccert_serial_number"
#define MAIL_ATTR_CCERT_EMAILS	"ccert_emails"
